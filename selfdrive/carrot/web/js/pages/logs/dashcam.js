...
function dashcamReportHtml(rep) {
  ...
  return `<div class="drpt">
    <section class="drpt-sec">
      ...
      <div class="drpt-kv"><span>${u("report_auto", "자동 주행")}</span><b>${escapeHtml(t.autoEnabledHms || "-")}</b>
        <small>${u("report_auto_active", "실제제어")} ${escapeHtml(t.autoActiveHms || "-")} · ${u("report_auto_ratio", "참여율")} ${escapeHtml(String(t.autoRatioPct ?? 0))}%</small></div>
      <div class="drpt-kv"><span>${u("report_manual", "수동 주행")}</span><b>${escapeHtml(t.manualHms || "-")}</b></div>
      <div class="drpt-kv drpt-kv--sub"><span>${u("report_manual_gas", "수동 Gas")}</span><b>${escapeHtml(t.manualGasMs || "-")}</b></div>
      <div class="drpt-kv drpt-kv--sub"><span>${u("report_manual_brake", "수동 Brake")}</span><b>${escapeHtml(t.manualBrakeMs || "-")}</b></div>
    </section>
